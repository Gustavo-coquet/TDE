...
export const QUESTOES_PADRAO: QuestaoPadrao[] = [
  {
    tema: "Mecânica — Leis de Newton", dificuldade: 2,
  ...
  {
    tema: "Cinemática — MRU", dificuldade: 1,
  ...
  {
    tema: "Termologia — Calor sensível", dificuldade: 3,
  ...
  {
    tema: "Matemática Financeira — Juros simples", dificuldade: 2,
  ...
  {
    tema: "Eletrodinâmica — Lei de Ohm", dificuldade: 2,
  ...
  {
    tema: "Estatística — Média aritmética", dificuldade: 1,
  ...
  {
    tema: "Resistência dos Materiais — Flexão (cálculo encadeado)", dificuldade: 4,
